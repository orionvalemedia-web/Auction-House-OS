...
Measured results for Devadex Auction House OS.
...
Performance or behaviour at high lot counts, high bid volumes, or large data files — no load testing was performed or claimed. No performance or load testing was carried out. No scale figures are claimed.
...
counts are the totals reported by the product's own test command.
